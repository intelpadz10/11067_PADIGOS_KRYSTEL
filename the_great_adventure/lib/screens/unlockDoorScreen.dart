...
import 'package:the_great_adventure/safe_cracker_widgets/sadeDial.dart';
...
class _DoorLockScreenState extends State<DoorLockScreen> {
  ...
  unlockSafe() {
    if (checkCombination()) {
      setState(() {
        isUnlocked = true;
        feedback = "You have unlocked the door. Go back to go inside.";
      });
    } else {
      setState(() {
        isUnlocked = false;
        feedback = "Oops! Wrong code, try again!";
      });
    }
  }
